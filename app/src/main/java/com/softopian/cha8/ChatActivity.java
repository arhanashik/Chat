...
public class ChatActivity extends AppCompatActivity implements Runnable {
    ...
    public void sendMessage(){
        ...
        String MyURL = Uri.parse("http://softopian.com/_android/com.softopian.cha8/send.php")
                .buildUpon()
    ...
    public void checkMessage(){
        ...
        String MyURL = Uri.parse("http://softopian.com/_android/com.softopian.cha8/fetch.php")
                .buildUpon()
                .appendQueryParameter("user", LoginActivity.username)
                .appendQueryParameter("pass", LoginActivity.password)
